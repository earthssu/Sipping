...
<head>
	...
	<script type="text/javascript">
		function mysubmit(num)
        {
            ...
            if(num == 3)
            {
                document.myform.action='./edit_text.php';
            }
            if(num == 4)
            {
                document.myform.action='./remove_text.php';
            }
            if(num == 5)
            {
	...
	<div>
		<form method="get" name="myform" enctype="multipart/form-data" style="margin-top: 10px; margin-right: 0%;">
    		...
    		<script>
      		...
      		<button id="recommend" name="recommend" class="btn waves-effect waves-light z-depth-0" type="submit" onclick="mysubmit(5)">RECOMMEND</button>
			<button id="button" name="remove" class="btn waves-effect waves-light z-depth-0" style="float: right; margin-left: 10px;" type="submit" onclick="mysubmit(4)">REMOVE</button>
			<button id="button" name="edit" class="btn waves-effect waves-light z-depth-0" style="float: right;" type="submit" onclick="mysubmit(3)">EDIT</button>
		</form>	
	</div>
